...
export const EXPOSITIVE_BET_MESSAGE =
  'Plataforma em modo expositivo. A finalização de apostas está temporariamente indisponível.';
export const EXPOSITIVE_DEPOSIT_MESSAGE =
  'Plataforma em modo expositivo. A finalização de depósitos está temporariamente indisponível.';
